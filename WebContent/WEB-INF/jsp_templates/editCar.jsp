    ...
    <div role="main" class="container">
	 ...
	 <% Car car=(Car)request.getAttribute("car");%>
      <div class="my-3 p-3 bg-trans rounded box-shadow">
        <h3 class=" border-gray pb-2 mb-0">
       Edit Your Car </h3>
        
        </div>
        <form action="/test/editCar" method="post">
         <div class="media bg-trans text-muted pt-3  rounded p-3 ">
          <img data-src="holder.js/32x32?theme=thumb&bg=007bff&fg=007bff&size=1" alt="" class="mr-2 rounded" src="images/im.svg">
           ...
           <font color="black">
            <strong >Model : </strong> &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model" value=<%=car.getModel() %>  required> <br>
           <strong> License Plate Number : </strong> <input type="text" name="matricule" value=<%=car.getMatricule() %> required> <br>
