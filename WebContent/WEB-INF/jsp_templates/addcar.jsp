...
<html lang="en">
  <head>
	...
	<!-- url pic1 https://i.pinimg.com/originals/a8/38/6b/a8386ba3925b135ab15e710b83fa3d42.jpg?fbclid=IwAR18piIXRb_G9qvqe6dxr9VlGV8gtTY9ihMv7yBYBHpy_z5u7BqvRxxdNkE -->
  </head>
    ...
    <div role="main" class="container">
	 ...
	 <% ArrayList<Car> cars=(ArrayList<Car>)request.getAttribute("cars");%>
      <div class="my-3 p-3 bg-trans rounded box-shadow">
        <h6 class=" border-gray pb-2 mb-0">
        Add a Car </h6>
        
        </div>
        <form action="/test/addCar" method="post">
         <div class="media bg-trans text-muted pt-3  rounded p-3 ">
          <img data-src="holder.js/32x32?theme=thumb&bg=007bff&fg=007bff&size=1" alt="" class="mr-2 rounded" src="images/im.svg">
           ...
           <font color="black">
            <strong >Model : </strong> &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model" value=""  required> <br>
           <strong> License Plate Number : </strong> <input type="text" name="matricule" value=""  required> <br>
            <strong> Id Gray Card : </strong> <input type="text" name="graycard" value=""  required> <br>
             <%
				String gc=(String)request.getAttribute("error");  
				if(gc!=null)
				out.println("<font color=red size=4px>"+gc+"</font>");
	 		%>
            </font>
          </p>
