    ...
    <div role="main" class="container">
	 ...
	 <% ArrayList<Car> cars=(ArrayList<Car>)request.getAttribute("cars");%>
      <div class="my-3 p-3 bg-trans rounded box-shadow">
        ...
        My Cars <font style="padding-left:750px"> <a class="btn btn-outline-secondary" href="/test/addCar">Add Car</a></font>
        </h6>
        ...
        <a class="btn btn-outline-secondary" href="/test/editCar?idCar=<%=car.getId()%>">Edit</a>&nbsp;
         <a class="btn btn-outline-secondary" href="/test/delete?idCar=<%=car.getId()%>" 
        onclick="return confirm('All paths and positions of this car will be deleted...\nContinue?!! ');">Delete</a>
